...
from vastai.serverless.server.lib.data_types import RequestMetrics, Session
...
class TestMetricsRequestLifecycle:
    ...
    def test_request_start_updates_pending_and_workload_for_plain_request(self, make_pyworker_metrics) -> None:
        """
    ...
    def test_request_end_removes_working_and_updates_last_request_served(self, make_pyworker_metrics) -> None:
        """
        ...
        """
        m = make_pyworker_metrics()
        req = RequestMetrics(request_idx=2, reqnum=3, workload=1.0, status="Started")
        m._request_start(req)
    ...
    def test_request_success_increments_served_and_marks_status(self, make_pyworker_metrics) -> None:
        """
        ...
        """
        m = make_pyworker_metrics()
        req = RequestMetrics(request_idx=1, reqnum=1, workload=4.0, status="Started")
    ...
    def test_request_errored_increments_errored_and_sets_status(self, make_pyworker_metrics) -> None:
        """
        ...
        """
        m = make_pyworker_metrics()
        req = RequestMetrics(request_idx=5, reqnum=5, workload=1.0, status="Started")
    ...
    def test_request_canceled_increments_cancelled(self, make_pyworker_metrics) -> None:
        """
        ...
        """
        m = make_pyworker_metrics()
        req = RequestMetrics(request_idx=9, reqnum=9, workload=0.5, status="Started")
        m._request_canceled(req)
        assert m.model_metrics.workload_cancelled == 0.5
        assert req.status == "Cancelled"
        assert req.success is True

    def test_request_reject_updates_rejected_and_queues_delete(self, make_pyworker_metrics) -> None:
        """
        ...
        """
        m = make_pyworker_metrics()
        req = RequestMetrics(request_idx=11, reqnum=11, workload=3.0, status="")
    ...
    def test_request_start_skips_recieved_dict_when_request_has_session(self, make_pyworker_metrics) -> None:
        """
...
class TestMetricsRequestIdFormatting:
    ...
    def test_request_id_plain_request(self, make_pyworker_metrics) -> None:
        """
        ...
        """
        m = make_pyworker_metrics()
        req = RequestMetrics(request_idx=3, reqnum=3, workload=1.0, status="")
        assert m._request_id(req) == "Request 3"

    def test_request_id_session_scope(self, make_pyworker_metrics) -> None:
        """
    ...
    def test_request_id_in_session_request(self, make_pyworker_metrics) -> None:
        """
...
class TestSendMetricsAndReset:
    ...
    async def test_send_metrics_posts_worker_status_and_resets_on_success(self, make_pyworker_metrics, aiohttp_sync_post_session_ok) -> None:
        """
        ...
        mock_session, _ = aiohttp_sync_post_session_ok()
    ...
    async def test_send_metrics_does_not_reset_when_all_posts_fail(self, make_pyworker_metrics) -> None:
        """
    ...
    async def test_send_metrics_retries_after_timeout_then_succeeds(self, make_pyworker_metrics, aiohttp_post_context_timeout, aiohttp_post_context_ok_pair) -> None:
        """
        ...
        m = make_pyworker_metrics()
        m.update_pending = True
        ctx_fail = aiohttp_post_context_timeout()
        ctx_ok, _ = aiohttp_post_context_ok_pair()
        mock_session = MagicMock()
    ...
    async def test_send_metrics_with_none_mtoken_obfuscates_log_field_to_empty(self, make_pyworker_metrics, aiohttp_sync_post_session_ok) -> None:
        """
...
class TestSendDeleteRequestsAndReset:
    ...
    async def test_delete_requests_skips_cloud_vast_and_sends_to_next(self, make_pyworker_metrics, aiohttp_sync_post_session_ok) -> None:
        """
    ...
    async def test_delete_requests_posts_only_failed_batch_when_no_successes(self, make_pyworker_metrics, aiohttp_sync_post_session_ok) -> None:
        """
    ...
    async def test_delete_requests_posts_success_and_failure_batches_separately(self, make_pyworker_metrics, aiohttp_sync_post_session_ok) -> None:
        """
    ...
    async def test_delete_requests_retries_after_timeout_then_succeeds(self, make_pyworker_metrics, aiohttp_post_context_timeout, aiohttp_post_context_ok_pair) -> None:
        """
    ...
    async def test_delete_requests_retries_after_generic_exception_then_succeeds(self, make_pyworker_metrics, aiohttp_post_context_ok_pair) -> None:
        """
        ...
        m.model_metrics.requests_deleting = [req]
        ctx_fail = MagicMock()
        ctx_fail.__aenter__ = AsyncMock(side_effect=ValueError("boom"))
    ...
    async def test_delete_requests_retains_queue_when_all_post_attempts_fail(self, make_pyworker_metrics) -> None:
        """
        ...
        m.model_metrics.requests_deleting = [req]
        ctx_fail = MagicMock()
        ctx_fail.__aenter__ = AsyncMock(side_effect=ValueError("always fail"))
        ctx_fail.__aexit__ = AsyncMock(return_value=None)
        mock_session = MagicMock()
...
class TestSendDeleteRequestsLoop:
    ...
    async def test_delete_loop_calls_send_when_queue_nonempty(self, make_pyworker_metrics) -> None:
        """
...
class TestSendMetricsLoop:
    ...
    async def test_metrics_loop_calls_send_when_elapsed_ge_10_and_model_not_loaded(self, make_pyworker_metrics) -> None:
        """
    ...
    async def test_metrics_loop_calls_send_when_update_pending(self, make_pyworker_metrics) -> None:
        """
        ...
        with patch("vastai.serverless.server.lib.metrics.time") as mock_time:
            mock_time.time.return_value = 1_000_005.0
            with patch.object(
                m,
                "_Metrics__send_metrics_and_reset",
                mock_send,
...
class TestMetricsHttpSession:
    ...
    async def test_http_creates_session_once(self, make_pyworker_metrics) -> None:
        """
    ...
    async def test_aclose_closes_and_clears_session(self, make_pyworker_metrics) -> None:
        """
